...
if (!empty($search)) {
    ...
    $sql = "SELECT * FROM shoes WHERE status='listed' AND (brand LIKE '%$search%' OR type LIKE '%$search%'
    OR gender LIKE '%$search%' OR category LIKE '%$search%')";
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<p class='text-center mt-5'><b>Oops! Nothing matches your search.</b></p>";
    }
    $conn->close();
} else {
