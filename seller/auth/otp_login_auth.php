...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["otp_input"])) {
    ...
    if (!isset($_SESSION["otp"]) || !isset($_SESSION["otp_time"])) {
        ...
        //on success
        unset($_SESSION["otp"], $_SESSION["otp_time"], $_SESSION["seller_umail"]);
    ...
    try {
        ...
        $mail->addAddress($_SESSION["seller_umail"] ?? '');
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                <p>Dear User,</p>
                <p>We have received a request to log in to your seller account. To complete the login process, please use the following code:</p>
                <p class="otp">' . $otp . '</p>
