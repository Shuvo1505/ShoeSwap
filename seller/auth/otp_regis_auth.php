...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["otp_input"])) {
    ...
    if (!isset($_SESSION["otp"]) || !isset($_SESSION["otp_time"])) {
        ...
        $pass = $_SESSION['seller_pass'];
        $security = $_SESSION['seller_security'];
        $sql="INSERT INTO seller(USERNAME,EMAIL_ID,PASSWORD,SECURITY_QUES) VALUES ('$user','$email','$pass','$security')";
        $result=mysqli_query($conn,$sql);
        unset($_SESSION['seller_pass'], $_SESSION['seller_email'], $_SESSION['seller_security']);
        ...
        $mail->Body = '
                    ...
                    <body>
                        <div class="container">
                            ...
                            <div class="content">
                                <p>Dear User,</p>
                                <p>We have received a request to create your seller account. To complete the account creation process, please use the following code:</p>
                                <p class="otp">' . $otp . '</p>
